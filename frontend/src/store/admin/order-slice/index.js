...
export const getAllOrdersForAllUser = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(
      `https://trendora-backend-gp4y.onrender.com/api/v1/admin/order/get`
    );
...
export const getOrderDetails = createAsyncThunk(
  ...
  async (id) => {
    const response = await axios.get(
      `https://trendora-backend-gp4y.onrender.com/api/v1/admin/order/details/${id}`
    );
...
export const updateOrderStatus = createAsyncThunk(
  ...
  async ({ id, data }) => {
    ...
    const response = await axios.put(
      `https://trendora-backend-gp4y.onrender.com/api/v1/admin/order/update/${id}`,
      data
    );
