...
export const registerUser = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.post(
      "https://trendora-backend-gp4y.onrender.com/api/v1/users/register",
      data,
      {
...
export const loginUser = createAsyncThunk(
  ...
  async (data) => {
    const response = await axios.post(
      "https://trendora-backend-gp4y.onrender.com/api/v1/users/login",
      data,
      {
        withCredentials: true,
      }
...
export const logoutUser = createAsyncThunk("/auth/logoutUser", async () => {
  const response = await axios.post(
    "https://trendora-backend-gp4y.onrender.com/api/v1/users/logout",
    {},
    {
      withCredentials: true,
    }
...
export const checkAuth = createAsyncThunk("/auth/checkAuth", async () => {
  const response = await axios.get(
    "https://trendora-backend-gp4y.onrender.com/api/v1/users/check-auth",
    {
      withCredentials: true,
      headers: {
        "Cache-Control":
...
export const loginAsGuest = createAsyncThunk(
  ...
  async () => {
    const response = await axios.post(
      "https://trendora-backend-gp4y.onrender.com/api/v1/users/guest-login",
      {},
      {
        withCredentials: true,
      }
